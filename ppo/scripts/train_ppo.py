...
def record_video(agent, env_name="MountainCarContinuous-v0", video_folder="ppo_videos", seed=42):
...
def main():
    ...
    parser.add_argument("--env_name", type=str, default="MountainCarContinuous-v0", help="Gym environment name")
